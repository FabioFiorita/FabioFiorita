...
-  🚀 Currently working as a Mid-Level Full-Stack Engineer at Medome.
...
-  [**ItsMedTime**](https://fabiofiorita.vercel.app/itsmedtime)
    ...
    <img src="https://fabiofiorita.vercel.app/itsmedtime.png" alt="ItsMedTime" width="150"/>
...
-  [**Tastik**](https://fabiofiorita.vercel.app/tastik)
    ...
    <img src="https://fabiofiorita.vercel.app/tastik.png" alt="Tastik" width="150"/>
   
    Tastik is a private, local-first list app for iPhone that gives every list the shape it needs—simple checklists, steppers for quantities, calculator lists with running totals, Kanban boards, and mixed multi-type lists that combine it all. It works with no account required, keeps your data on-device with optional iCloud sync, and adds tags, notes, search, Home and Lock Screen widgets, App Shortcuts, starter templates, and Smart Add for turning natural language into tidy items. Built with Swift and SwiftUI on a local-first data layer, Tastik prioritizes privacy, flexibility, and speed.
